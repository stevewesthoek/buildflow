...
import { controlBuildFlowAgentRun, makeActivity, unwrapActionError } from '@/lib/actions/gpt'
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const data = await controlBuildFlowAgentRun(body, auth.bearerToken) as Record<string, unknown>
